...
<body>
    ...
    <div class="dcont">
        ...
        <div class="mainCont" id="main">
            ...
            <div class="pageCont">
                <div class="conta p30">
                    <h3> اضافة وتعديل مشروع </h3>
                    <div class="btns">
                        <a href="./add-project.php" class="saveBtn">اضافة مشروع +</a>
                    </div>
                </div>
                <div class="conta p30">
                    <form class="taIn">
                            ...
                            <tbody>
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<td class='mw200'>" . $row['project_name'] . "</td>";
                                        echo "<td class='tools'>
                                        <a href='edit-project.php?id=" . $row['id'] . "'>
                                            <img src='../media/icons/edit.png' alt='' id='edit'>
                                        </a>
                                        <img src='../media/icons/delete.png' alt='' onclick='deleteProject(" . $row['id'] . ")'>
                                    </td>";
                                                    echo "</tr>";
                                    }
                                } else {
                                    echo "<tr><td colspan='3'>لا توجد مشاريع</td></tr>";
                                }
                                $conn->close();
                                ?>
                            </tbody>
...
<script>
        function deleteProject(id) {
            if (confirm('هل أنت متأكد أنك تريد حذف هذا المشروع؟')) {
                window.location.href = '../../backend/delete_project.php?id=' + id;
            }
        }
    </script>
