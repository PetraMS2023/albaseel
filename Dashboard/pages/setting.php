    ...
    <div class="dcont">
        ...
        <div class="mainCont" id="main">
            ...
            <div class="pageCont">
                ...
                <div class="conta p30">
                    <form class="inputs" action="../../backend/upload_slider_image.php" method="post"
                        enctype="multipart/form-data">
                        <div class="input">
                            <span>صور السلايدر في الصفحة الرئيسية:</span>
                            
                            <div class="customInput">
                                <input type="file" name="image_file" accept="image/*" hidden id="file" required>
                            ...
                            <tbody>
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        echo "<tr>";
                                        echo "<td class='mw200'>" . $row['id'] . "</td>";
                                        echo "<td><img src='../" . $row['image_path'] . "' alt='Slider Image'></td>";
                                        echo "<td class='tools'>
                                              <img src='../media/icons/delete.png' alt='Delete' onclick='deleteImage(" . $row['id'] . ")'>
                                            </td>";
                                        echo "</tr>";
                                    }
                                } else {
                                    echo "<tr><td colspan='3'>لا توجد صور متاحة حاليا.</td></tr>";
                                }
                                ?>
                            </tbody>
                        </table>
...
<script>
    function deleteImage(id) {
        if (confirm('هل أنت متأكد أنك تريد حذف هذه الصورة؟')) {
            window.location.href = '../../backend/delete_slider_image.php?id=' + id;
        }
    }
</script>
