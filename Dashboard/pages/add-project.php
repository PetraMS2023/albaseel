...
<body>
    ...
    <div class="dcont">
        ...
        <div class="mainCont" id="main">
            ...
            <div class="pageCont">
                <div class="conta p30">
                    <h3> اضافة المشاريع </h3>
                </div>
                <div class="conta p30">
                    <form class="inputs" action="../../backend/upload_project.php" method="post" enctype="multipart/form-data">
                        <div class="ff">
                            <div class="input">
                                <span>اسم المشروع باللغة الانجليزية</span>
                                <input type="text" name="project_name" spellcheck="false" placeholder="اسم المشروع باللغة الانجليزية"
                                    required>
                            </div>
                            <div class="input">
                                <span>اسم المشروع باللغة العربية</span>
                                <input type="text" name="project_name_ar" spellcheck="false" placeholder="اسم المشروع باللغة العربية"
                                    required>
                            </div>
                        ...
                        <div class="ff">
                            <div class="input">
                                ...
                                <input type="text" name="project_location" spellcheck="false"
                                    placeholder="https://maps.app.goo.gl/qjH7kwugP7B4wyrQ6" required>
                            </div>
                            <div class="input">
                                <span>حالة المشروع:</span>
                                <select name="project_status" required>
                                    <option value="مشروع مباع">مشروع مباع</option>
                                    <option value="مشروع متاح">مشروع متاح</option>
                                </select>
                            </div>
                        </div>
                        <div class="input">
                            <label for="before_images">تحميل الصور قبل :</label>
                            <div class="customInput">
                                <input type="file" name="before_images[]" accept="image/*" multiple hidden
                                    id="before_images">
                                <label for="before_images">تحميل <i
                                        class="fa-regular fa-arrow-up-from-bracket"></i></label>
                            </div>
                        </div>
                        <div class="input">
                            <label for="after_images">تحميل الصور بعد :</label>
                            <div class="customInput">
                                <input type="file" name="after_images[]" accept="image/*" multiple hidden
                                    id="after_images">
                                <label for="after_images">تحميل <i
                                        class="fa-regular fa-arrow-up-from-bracket"></i></label>
                            </div>
                        </div>
                        <div class="ff">
                          <div class="input">
                              <label for="project_description">وصف المشروع باللغة الانجليزية :</label>
                              <textarea name="project_description" placeholder="وصف المشروع باللغة الانجليزية" required></textarea>
                          </div>
                          <div class="input">
                              <label for="project_description">وصف المشروع باللغة العربية :</label>
                              <textarea name="project_description_ar" placeholder="وصف المشروع بالللغة العربية" required></textarea>
                          </div>
                        </div>
