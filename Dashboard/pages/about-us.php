...
<body>
  ...
  <div class="dcont">
    ...
    <form class="conta p30" action="../../backend/update_about_us.php" method="post">
        <h3>تعديل من نحن :</h3>
        <textarea class="txtArea" name="about_ar" placeholder="من نحن باللغة العربية" required><?php echo isset($about_us['about_ar']) ? $about_us['about_ar'] : ''; ?></textarea>
        <textarea class="txtArea" name="about_en" placeholder="من نحن باللغة الانجليزية" required><?php echo isset($about_us['about_en']) ? $about_us['about_en'] : ''; ?></textarea>
        <button class="saveBtn" type="submit">حفظ التعديلات</button>
    </form>
      <!-- End Main Content -->
    </div>
