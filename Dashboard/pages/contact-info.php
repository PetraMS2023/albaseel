    ...
    <div class="mainCont" id="main">
      ...
      <div class="pageCont">
        ...
        ?>
          ...
          <form class="inputs" action="../../backend/update_statistics.php" method="post">
            <div class="input">
              <span>الاعضاء</span>
              <input type="number" name="members" spellcheck="false" placeholder="الاعضاء"
                value="<?php echo isset($statistics['members']) ? $statistics['members'] : ''; ?>" required>
            </div>
            <div class="input">
              <span>عملائنا</span>
              <input type="number" name="clients" spellcheck="false" placeholder="عملائنا"
                value="<?php echo isset($statistics['clients']) ? $statistics['clients'] : ''; ?>" required>
            </div>
            <div class="input">
              <span>المشاريع</span>
              <input type="number" name="projects" spellcheck="false" placeholder="المشاريع"
                value="<?php echo isset($statistics['projects']) ? $statistics['projects'] : ''; ?>" required>
            </div>
            <div class="input">
              <span>اراء العملاء</span>
              <input type="number" name="customer_feedback" spellcheck="false" placeholder="اراء العملاء"
                value="<?php echo isset($statistics['customer_feedback']) ? $statistics['customer_feedback'] : ''; ?>"
                required>
            </div>
