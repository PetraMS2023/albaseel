    ...
    <div class="navCont">
      <ul class="nLinks">
        <li><a class="nLink" href="./home.php">
          ...
          <li><a class="nLink active" href="./emails.php">
    ...
    <div class="mainCont" id="main">
      ...
      <div class="pageCont">
        ...
        <div class="conta p30">
          ...
          $sql = "SELECT id, full_name, phone_number, email FROM contact_form";
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    echo "<tr>";
                    echo "<td class='mw200'>" . $row['full_name'] . "</td>";
                    echo "<td>" . $row['phone_number'] . "</td>";
                    echo "<td class='mw200'>" . $row['email'] . "</td>";
                    echo "<td class='tools'>
                            <a href='email-info.php?id=" . $row['id'] . "'>
                                <img src='../media/icons/edit.png' alt='' id='edit'>
                            </a>
                            <img src='../media/icons/delete.png' alt='' onclick='deleteContact(" . $row['id'] . ")'>
                          </td>";
                    echo "</tr>";
                }
            } else {
                echo "<tr><td colspan='4'>لا توجد بيانات متاحة حاليا.</td></tr>";
            }
            ?>
        </tbody>
    </table>
...
<script>
        function deleteContact(id) {
            if (confirm('هل أنت متأكد أنك تريد حذف هذا الاتصال؟')) {
                window.location.href = '../../backend/delete_contact.php?id=' + id;
            }
        }
</script>
